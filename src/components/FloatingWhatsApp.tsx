...
export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      aria-label={label}
      title={label}
      className="group fixed bottom-5 right-5 z-[960] inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-[#062414] shadow-[0_18px_42px_rgba(37,211,102,0.34)] transition-all duration-300 hover:-translate-y-1 hover:scale-105 hover:bg-[#35e173] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#d4ff59] focus-visible:ring-offset-2 focus-visible:ring-offset-black active:translate-y-0 active:scale-95 md:bottom-7 md:right-7 md:h-16 md:w-16"
    >
